  ...
  return (
    <div className="flex flex-col items-center justify-between min-h-screen p-4 md:p-8 bg-[url(/background.png)] bg-cover bg-center">
      ...
      <main className="flex flex-col gap-8 w-full">
        ...
        <div className="flex flex-col gap-4 items-center w-full md:w-fit md:m-auto -translate-y-3">
          <a
          ...
          <div
            className="border border-white text-white rounded-full px-8 py-4 text-[16px] md:text-[20px] flex items-center gap-2 w-full"
          >
            ...
            <span className="flex-1 text-center">Coming soon to Android</span>
          </div>
        </div>
      </main>
